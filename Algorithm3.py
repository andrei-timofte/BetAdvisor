...
class Algorithm3:
    ...
    def __init__(self, meciuri, path_for_logs):
        self.name = "PPG Difference Algorithm"
    ...
    def analyze(self, competitie: str):
        ...
        for meci in self.meciuri[competitie]:
            ...
            try:
                ...
                if away_team_ppg < home_team_min_won_ppga and away_team_ppg < home_team_min_lost_ppga:
                    home_team_wins = True
                away_team_wins = False
                if home_team_ppg < away_team_min_won_ppga and home_team_ppg < away_team_min_lost_ppga:
                    away_team_wins = True
