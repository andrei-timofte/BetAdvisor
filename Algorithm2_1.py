        ...
        for meci in self.meciuri[competitie]:
            ...
            if len(overlapped) < 2:
                ...
                if home_team_graph[index] > (away_team_graph[index] + index):
                    if 'FINAL' in self.meciuri[competitie][meci]['Cote'].keys():
                        if self.meciuri[competitie][meci]['Cote']['FINAL']['1'] <= self.meciuri[competitie][meci]['Cote']['FINAL']['2']:
                            winners[competitie][meci] = home_team
                elif (home_team_graph[index] + index) < away_team_graph[index]:
                    if 'FINAL' in self.meciuri[competitie][meci]['Cote'].keys():
                        if self.meciuri[competitie][meci]['Cote']['FINAL']['2'] <= self.meciuri[competitie][meci]['Cote']['FINAL']['1']:
